...
?>
<section class="sc-blog-pages-area sc-pt-120 sc-md-pt-80 sc-pb-20 sc-md-pb-20 spria-custom-blog">
  <div class="container">
  	<div class="row">
				...
				if ( ( is_home() || is_archive() ) ) {
					if ( $blog_layout != 1 ) {
						...
						while ( have_posts() ) : the_post();
							echo '<div class="col-lg-'. esc_attr( $blog_grid ) .'">';
				 ...
				 get_template_part( 'framework/content', 'none' ); 
			endif;
			*/ 
			?>
