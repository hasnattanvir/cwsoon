(function ($) {
    ...
    $(window).on("load", function () {
     ...
     /*-- spria scroll top scripts start --*/
    var spriaScrollTop = document.querySelector(".spria-scroll-top");
    if (spriaScrollTop != null) {
        var scrollProgressPatch = document.querySelector(".spria-scroll-top path");
        ...
        window.addEventListener("scroll", function (event) {
            ...
            if (scrollElementPos >= offset) {
                spriaScrollTop.classList.add("progress-done");
            } else {
                spriaScrollTop.classList.remove("progress-done");
            }
        });
        spriaScrollTop.addEventListener("click", function (e) {
            e.preventDefault();
            window.scroll({
                top: 0,
                left: 0,
