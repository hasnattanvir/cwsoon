...
!(function (e, t) {
    ...
    var S = {
        ...
        usc_post_dateSlides: function () {
            ...
            for (let i = 0; i < p; i += 1) {
                $ = 0;
                const n = c.eq(i);
                if ((T && e.grid.usc_post_dateSlide(i, n, p, t), "none" !== n.css("display"))) {
            ...
            if (
                ...
                T && e.grid.usc_post_dateWrapperSize($, u, t),
                !a.centeredSlides)
            ) {
                const t = [];
            ...
            if (
                ...
                a.watchSlidesProgress && e.usc_post_dateSlidesOffset(),
        ...
        usc_post_dateAutoHeight: function (e) {
            const t = this,
                s = [],
        ...
        usc_post_dateSlidesOffset: function () {
            const e = this,
                t = e.slides;
            for (let s = 0; s < t.length; s += 1)
                t[s].swiperSlideOffset = e.isHorizontal() ? t[s].offsetLeft : t[s].offsetTop;
        },
        usc_post_dateSlidesProgress: function (e) {
            void 0 === e && (e = (this && this.translate) || 0);
            const t = this,
                s = t.params,
                { slides: a, rtlTranslate: i, snapGrid: r } = t;
            if (0 === a.length) return;
            void 0 === a[0].swiperSlideOffset && t.usc_post_dateSlidesOffset();
            let n = -e;
        ...
        usc_post_dateProgress: function (e) {
            const t = this;
            if (void 0 === e) {
            ...
            0 === a ? ((i = 0), (r = !0), (n = !0)) : ((i = (e - t.minTranslate()) / a), (r = i <= 0), (n = i >= 1)),
                ...
                (s.watchSlidesProgress || (s.centeredSlides && s.autoHeight)) && t.usc_post_dateSlidesProgress(e),
                r && !l && t.emit("reachBeginning toEdge"),
                n && !o && t.emit("reachEnd toEdge"),
                ((l && !r) || (o && !n)) && t.emit("fromEdge"),
                t.emit("progress", i);
        },
        usc_post_dateSlidesClasses: function () {
            const e = this,
        ...
        usc_post_dateActiveIndex: function (e) {
            const t = this,
        ...
        usc_post_dateClickedSlide: function (e) {
            const t = this,
                s = t.params,
    ...
    var M = {
        ...
        translateTo: function (e, t, s, a, i) {
            ...
            const o = r.minTranslate(),
                d = r.maxTranslate();
            let c;
            if (((c = a && e > o ? o : a && e < d ? d : e), r.usc_post_dateProgress(c), n.cssMode)) {
    ...
    var k = {
        slideTo: function (e, t, s, a, i) {
            ...
            if (
                ...
                r.usc_post_dateProgress(v),
                (b = n > p ? "next" : n < p ? "prev" : "reset"),
                (u && -v === r.translate) || (!u && v === r.translate))
            )
                return (
                    r.usc_post_dateActiveIndex(n),
                    l.autoHeight && r.usc_post_dateAutoHeight(),
                    r.usc_post_dateSlidesClasses(),
    ...
    function O(e) {
        ...
        r.followFinger &&
            ...
            (((r.freeMode && r.freeMode.enabled && s.freeMode) || r.watchSlidesProgress) &&
                (s.usc_post_dateActiveIndex(), s.usc_post_dateSlidesClasses()),
            s.params.freeMode && r.freeMode.enabled && s.freeMode && s.freeMode.onTouchMove(),
            s.usc_post_dateProgress(i.currentTranslate),
    ...
    function I(e) {
        ...
        if (t.allowClick) {
            ...
            t.usc_post_dateClickedSlide((e && e[0]) || o.target),
                t.emit("tap click", o),
    ...
    function A() {
        ...
        (e.allowSlideNext = !0),
            (e.allowSlidePrev = !0),
            e.usc_post_dateSize(),
            e.usc_post_dateSlides(),
            e.usc_post_dateSlidesClasses(),
    ...
    function G() {
        ...
        (e.previousTranslate = e.translate),
            ...
            e.usc_post_dateActiveIndex(),
            e.usc_post_dateSlidesClasses();
        const r = e.maxTranslate() - e.minTranslate();
        (i = 0 === r ? 0 : (e.translate - e.minTranslate()) / r),
            i !== e.progress && e.usc_post_dateProgress(s ? -e.translate : e.translate),
    ...
    const H = (e, t) => {
        ...
        (i.preventClicks || i.preventClicksPropagation) && n[p]("click", e.onClick, !0),
            ...
            i.usc_post_dateOnWindowResize
                ? e[u](o.ios || o.android ? "resize orientationchange observerUsc_post_date" : "resize observerUsc_post_date", A, !0)
                : e[u]("observerUsc_post_date", A, !0);
    };
    var X = {
            ...
            transition: {
                ...
                transitionStart: function (e, t) {
                    ...
                    const s = this,
                        { params: a } = s;
                    a.cssMode ||
                        (a.autoHeight && s.usc_post_dateAutoHeight(),
                    ...
                    function t() {
                        null != e &&
                            ...
                            e.imagesLoaded === e.imagesToLoad.length &&
                                (e.params.usc_post_dateOnImagesReady && e.usc_post_date(), e.emit("imagesReady")));
                    }
    ...
    class V {
        ...
        setProgress(e, t) {
            ...
            s.translateTo(i, void 0 === t ? 0 : t), s.usc_post_dateActiveIndex(), s.usc_post_dateSlidesClasses();
        }
        ...
        usc_post_date() {
            ...
            function a() {
                ...
                e.setTranslate(s), e.usc_post_dateActiveIndex(), e.usc_post_dateSlidesClasses();
            }
            let i;
            s.breakpoints && e.setBreakpoint(),
                e.usc_post_dateSize(),
                e.usc_post_dateSlides(),
                e.usc_post_dateProgress(),
                e.usc_post_dateSlidesClasses(),
                e.params.freeMode && e.params.freeMode.enabled
                    ? (a(), e.params.autoHeight && e.usc_post_dateAutoHeight())
                    : ((i =
    ...
    function K(e) {
        ...
        a.loop && t.loopCreate(), a.observer || t.usc_post_date();
    }
    function Z(e) {
        const t = this,
        ...
        s.loop && t.loopCreate(), s.observer || t.usc_post_date(), t.slideTo(r, 0, !1);
    }
    function Q(e, t) {
        const s = this,
                ...
                const n = [],
                    ...
                    o = function (e, t) {
                        ...
                        const s = new (l.MutationObserver || l.WebkitMutationObserver)((e) => {
                            if (1 === e.length) return void i("observerUsc_post_date", e[0]);
                            const t = function () {
                                i("observerUsc_post_date", e[0]);
                            };
    ...
    const re = [
        function (e) {
            ...
            function l(e) {
                ...
                s.params.cssMode || s.usc_post_dateActiveIndex();
                ...
                function y() {
                    s.usc_post_dateSlides(),
                        s.usc_post_dateProgress(),
                        s.usc_post_dateSlidesClasses(),
                        s.lazy && s.params.lazy.enabled && s.lazy.load(),
                        r("virtualUsc_post_date");
                }
                if (
                ...
                if (s.params.virtual.renderExternal)
                    return (
                        ...
                        void (s.params.virtual.renderExternalUsc_post_date ? y() : r("virtualUsc_post_date"))
                    );
                const E = [],
                    C = [];
                ...
                if (
                    ...
                    if (!a) {
                        ...
                        if (
                            ...
                            t.setTransition(0),
                            t.setTranslate(n),
                            t.usc_post_dateProgress(),
                            t.usc_post_dateActiveIndex(),
                            t.usc_post_dateSlidesClasses(),
                            ((!d && t.isBeginning) || (!u && t.isEnd)) && t.usc_post_dateSlidesClasses(),
        ...
        function (e) {
            ...
            function b(e) {
                ...
                t.usc_post_dateProgress(n), t.setTranslate(n), t.usc_post_dateActiveIndex(), t.usc_post_dateSlidesClasses();
            }
            function x(e) {
            ...
            s({
                ...
                i("usc_post_date resize observerUsc_post_date lock unlock", () => {
                    v();
                }),
                i("setTranslate", () => {
                    g();
                        ...
                        n.each((e) => {
                            ...
                            t.loadImage(n[0], c || l, p, u, !1, () => {
                                if (null != t && t && (!t || t.params) && !t.destroyed) {
                                    ...
                                    i("lazyImageReady", r[0], n[0]), t.params.autoHeight && t.usc_post_dateAutoHeight();
                                }
                            }),
        ...
        function (e) {
            ...
            (t.thumbs = { swiper: null }),
                ...
                a("slideChange usc_post_date resize observerUsc_post_date", () => {
                    o();
                }),
                a("setTransition", (e, s) => {
                ...
                Object.assign(t.thumbs, { init: l, usc_post_date: o });
        },
        function (e) {
                        ...
                        onTouchEnd: function (e) {
                            ...
                            if (s < -t.minTranslate()) t.slideTo(t.activeIndex);
                                ...
                                (!r.freeMode.momentum || c >= r.longSwipesMs) &&
                                    (t.usc_post_dateProgress(), t.usc_post_dateActiveIndex(), t.usc_post_dateSlidesClasses());
                            }
                        },
                    },
                });
        ...
        function (e) {
            ...
            r({ grid: { rows: 1, fill: "column" } }),
                (i.grid = {
                    ...
                    usc_post_dateWrapperSize: (e, s, a) => {
