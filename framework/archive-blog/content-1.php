...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'blog-layout-1 '.$thumb_img ); ?>>
    <div class="blog-item">
        ...
        <div class="blog-content">
            <?php
                if (!empty( ($sc_post_admin || $sc_post_date || $sc_post_cat) && has_post_thumbnail() ))  {
            ...
            <div class="blog-list-menu list_menu">
                <ul class="blog-list">
                    ...
                    <li><i class="ri-chat-3-fill"></i><a href="#"> <?php echo esc_html($comment_message, 'spria'); ?> </a></li>
                </ul>
            </div>
            ...
            <a class="readmore" href="<?php the_permalink(); ?>"><?php echo esc_html( 'Read More', 'spria' ) ?> </a>
        </div>
    </div>
</article>