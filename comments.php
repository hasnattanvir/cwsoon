...
<div id="comments" class="comments-area single-blog-form contact-box">
    ...
    $spriatheme_args = array(
        ...
        'submit_button' => '<div class="form-btn"><button type="submit" class="comment-submit-button">'.esc_attr__( 'Post Comment', 'spria' ).'<span class="hover_overlay"></span></button></div>',
